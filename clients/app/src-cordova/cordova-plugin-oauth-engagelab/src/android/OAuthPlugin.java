...
package com.engagelab.cordova.oauth;
...
public class OAuthPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) {
        ...
        } else if ("openInSystem".equals(action)) {
          try {
                String webEndpoint = args.getString(0);

                this.openInSystem(webEndpoint);
    ...
    private void startOAuth(String url) {
        ...
        if (packageName != null) {
           LOG.e(TAG, "Chosen tab Provider: " + packageName);
    ...
    /**
     * Launches a system browser with the web endpoint URL.
     *
     * @param url The URL of the OAuth endpoint.
     */
    private void openInSystem(String url) {
        ...
        try {
          context.startActivity(intent);
            ...
            LOG.e(TAG, "Open external browser failed");
            e.printStackTrace();
        }
    }
    ...
    private String findCustomTabProvider() {
        ...
        // Prefer chrome browser if available
        } else if (packagesSupportingCustomTabs.contains("com.android.chrome")) {
            this.tabProvider = "com.android.chrome";
        ...
        String nameList = "";
        for(String name : packagesSupportingCustomTabs)
        {
            nameList = nameList + " " + name;
        }
        LOG.e(TAG, "Tab provider packages found: " + nameList);
        return this.tabProvider;
    }
